...
export const CubesLinearIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  ...
  >
    ...
    <path
      ...
      strokeWidth="1.5"
    />
    <path d="M17.6799 10.82V6.73999" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
    <path
    ...
    <path
      ...
      strokeWidth="1.5"
    />
    <path d="M6.31995 21.82V17.74" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
    <path
